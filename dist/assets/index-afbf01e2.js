 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Po=new El("@firebase/auth");function Ss(t,...e){Po.logLevel<=ae.ERROR&&Po.error(`Auth (${nr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ll{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Ll.type="NONE";const Oo=Ll;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function No(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Fl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ul(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(jl(e))return"Blackberry";if(Hl(e))return"Webos";if(Ti(e))return"Safari";if((e.includes("chrome/")||$l(e))&&!e.includes("edge/"))return"Chrome";if(Bl(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=t.match(n);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function Ul(t=Se()){return/firefox\//i.test(t)}function Ti(t=Se()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function $l(t=Se()){return/crios\//i.test(t)}function Fl(t=Se()){return/iemobile/i.test(t)}function Bl(t=Se()){return/android/i.test(t)}function jl(t=Se()){return/blackberry/i.test(t)}function Hl(t=Se()){return/webos/i.test(t)}function sr(t=Se()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Zh(t=Se()){var e;return sr(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function ep(){return _d()&&document.documentMode===10}function Vl(t=Se()){return sr(t)||Bl(t)||Hl(t)||jl(t)||/windows phone/i.test(t)||Fl(t)}function tp(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wl(t,e=[]){let n;switch(t){case"Browser":n=No(Se());break;case"Worker":n=`${No(Se())}-${t}`;break;default:n=t}const s=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${nr}/${s}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function bp(t,e,n=!1){const{auth:s}=t,r="reauthenticate";try{const i=await wn(t,Kl(s,r,e,t),n);$(i.idToken,s,"internal-error");const o=xi(i.idToken);$(o,s,"internal-error");const{sub:a}=o;return $(t.uid===a,s,"user-mismatch"),en._forOperation(t,r,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Ve(s,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kv(t,e,n){const s=Xe(t),r={requestType:"PASSWORD_RESET",email:e};n&&yp(s,r,n),await up(s,r)}async function wp(t,e,n){const s=An(t),r=await mp(s,{returnSecureToken:!0,email:e,password:n}),i=await en._fromIdTokenResponse(s,"signIn",r);return await s._updateCurrentUser(i.user),i}function Ep(t,e,n){return vp(Xe(t),On.credential(e,n))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */dn(Bg,jg,"app");const Ai="/assets/Telegram-c178456d.svg",Oi="/assets/WhatsApp-64705ce5.svg",Ni="/assets/Instagram-d32ffc78.svg",at=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},Hg={props:{buttonName:String},data:()=>({contact:!1,store:ce()}),methods:{showContacts(){this.contact=!0},closeModal(){this.contact=!1}}},Vg={class:"grid [&_*]:font-roboto"},Wg={class:"grid grid-cols-[max-content_auto_max-content] text-[40px] max-[700px]:grid-cols-1 max-[700px]:text-[30px]"},zg={class:"bg-gray-200 font-bold font-roboto rounded-[10px] px-2 text-black text-center"},Kg=m("span",{class:"justify-self-center max-[700px]:hidden"},"|",-1),qg={class:"grid grid-cols-2 max-[700px]:grid-cols-1"},Gg={class:"text-3xl max-[700px]:text-2xl mb-[5px] font-semibold font-roboto"},Jg={class:"text-2xl max-[700px]:text-xl font-roboto"},Yg={class:"text-2xl max-[7000px]:text-xl mb-[20px] font-roboto"},Xg={class:"text-3xl max-[700px]:text-2xl mb-[5px] font-roboto font-semibold"},Qg=m("p",{class:"text-2xl max-[700px]:text-xl mb-[20px] font-roboto"},"+996779454233",-1),Zg={class:"grid auto-rows-min gap-[10px] [&_a]:mr-[10px]"},em={class:"text-3xl max-[700px]:text-2xl font-roboto font-semibold"},tm=_i('<div class="flex items-center"><a href="https://t.me/+996779454233" target="_blank"><img class="inline" src="'+Ai+'" alt=""></a><p class="text-2xl max-[700px]:text-xl font-roboto">+996779454233</p></div><div class="flex items-center"><a href="https://wa.me/79146089174" target="_blank"><img class="inline" src="'+Oi+'" alt=""></a><p class="text-2xl max-[700px]:text-xl">+79146089174</p></div><div class="flex items-center mb-[20px]"><a href="https://www.instagram.com/crafthoney.kg" target="_blank"><img class="inline" src="'+Ni+'" alt=""></a><p class="text-2xl max-[700px]:text-xl font-roboto">crafthoney.kg</p></div>',3),nm=m("div",null,[m("p",{class:"text-3xl max-[700px]:text-2xl mb-[5px] font-roboto font-semibold"},"E-mail:"),m("p",{class:"text-2xl max-[700px]:text-xl font-roboto"},"crafthoneykg@gmail.com")],-1);function sm(t,e,n,s,r,i){return he(),we("div",Vg,[m("div",Wg,[m("span",zg,j(t.store.langProp.contacts),1),Kg,m("button",{onClick:e[0]||(e[0]=o=>t.store.comp="Feedback"),class:"bg-[#EAAD02] rounded-[10px] px-2 text-white"},j(t.store.langProp.feedback),1)]),m("div",qg,[m("div",null,[m("p",Gg,j(t.store.langProp.address),1),m("p",Jg,"770033, "+j(t.store.langProp.kyrgyzstan),1),m("p",Yg,j(t.store.langProp.street),1)]),m("div",null,[m("p",Xg,j(t.store.langProp.telephone),1),Qg]),m("div",Zg,[m("p",em,j(t.store.langProp.socialnetworks),1),tm]),nm])])}const oc=at(Hg,[["render",sm]]),rm="/assets/Register_1-5c661edd.svg",ac="/assets/Enter_1-7f28cdb9.svg",im={data(){return{store:ce(),lang:ce().lang}}},om={class:""},am={class:"flex flex-col justify-center [&>*]:px-[10px]"},lm={class:"flex justify-between mt-[8px]"},cm={class:"self-center text-xl text-center h-[32px] w-[56px] bg-[#DAE2E2] border-[2px] border-black rounded-xl hover:cursor-pointer hover:text-amber-700 hover:bg-amber-200 underline-offset-4",name:"store.lang",id:""},um={selected:"",disabled:"",hidden:""},fm=m("strong",null,"X",-1),dm=[fm],hm={key:0,class:"flex flex-col items-center border-b-[1px] border-[#BCB9B9]"},pm=m("img",{class:"w-[24px] h-24[px] mr-[10px]",src:rm,alt:""},null,-1),gm=m("img",{class:"w-[24px] h-[24px] mr-[10px]",src:ac,alt:""},null,-1),mm={key:1,class:"flex justify-center border-b-[1px] border-[#BCB9B9]"},_m=m("img",{class:"w-[24px] h-[24px] mr-[10px]",src:ac,alt:""},null,-1),bm={class:"my-[20px] px-[10px]"},vm=_i('<div class="grid grid-cols-2 gap-[80px]"><div class="flex items-center"><p class="font-inter text-[16px] text-black">+996779454233</p></div><div class="flex justify-around items-center"><a href="https://www.instagram.com/crafthoney.kg" target="_blank"><img src="'+Ni+'" alt=""></a><a href="https://wa.me/79146089174" target="_blank"><img src="'+Oi+'" alt=""></a><a href="https://t.me/+996779454233" target="_blank"><img src="'+Ai+'" alt=""></a></div></div>',1),ym={class:"my-[10px]"},wm={class:"my-[10px]"};function Em(t,e,n,s,r,i){const o=Xt("router-link");return he(),we("div",om,[m("div",am,[m("div",lm,[m("select",cm,[m("option",um,j(r.store.lang.toUpperCase()),1),m("option",{onClick:e[0]||(e[0]=a=>(r.store.lang="ru",t.$router.push(`/ru/${t.$route.path.slice(4,t.$route.path.length)}`))),value:""},"RU"),m("option",{onClick:e[1]||(e[1]=a=>(r.store.lang="en",t.$router.push(`/en/${t.$route.path.slice(4,t.$route.path.length)}`))),value:""},"EN"),m("option",{onClick:e[2]||(e[2]=a=>(r.store.lang="kg",t.$router.push(`/kg/${t.$route.path.slice(4,t.$route.path.length)}`))),value:""},"KG")]),m("button",{onClick:e[3]||(e[3]=a=>t.$emit("changeBurger")),class:"w-fit focus:outline-none text-[24px] text-right hover:text-amber-700"},dm)]),ee(o,{to:`/${r.lang}/Products`,class:"flex items-center w-full h-[46px] font-inter font-[200] text-[22px] border-b-[1px] border-black text-[#999999] hover:text-amber-700 hover:underline underline-offset-4"},{default:Le(()=>[Ie(j(r.store.langProp.catalogue),1)]),_:1},8,["to"]),ee(o,{to:`/${r.lang}/About`,class:"flex items-center w-full h-[46px] font-inter font-[200] text-[22px] border-b-[1px] border-black text-[#999999] hover:text-amber-700 hover:underline underline-offset-4"},{default:Le(()=>[Ie(j(r.store.langProp.aboutus),1)]),_:1},8,["to"]),ee(o,{to:`/${r.lang}/Blog`,class:"flex items-center w-full h-[46px] font-inter font-[200] text-[22px] border-b-[1px] border-black text-[#999999] hover:text-amber-700 hover:underline underline-offset-4"},{default:Le(()=>[Ie(j(r.store.langProp.blog),1)]),_:1},8,["to"]),m("button",{onClick:e[4]||(e[4]=a=>(r.store.modal=!0,t.$emit("changeBurger"),r.store.comp="Contacts",r.store.bg="bg-white")),class:"w-full h-[46px] text-left font-inter font-[200] text-[22px] border-b-[1px] border-black text-[#999999] hover:text-amber-700 hover:underline underline-offset-4"},j(r.store.langProp.contacts),1)]),r.store.loggedIn?nt("",!0):(he(),we("div",hm,[m("button",{onClick:e[5]||(e[5]=a=>(r.store.bg="bg-bee",r.store.modal=!0,t.$emit("changeBurger"),r.store.comp="Register")),class:"w-[218px] h-[47px] mt-[20px] flex justify-center items-center font-ubuntu font-[400] text-[16px] text-[#FFF9F9]"},[pm,Ie(j(r.store.langProp.registration),1)]),m("button",{onClick:e[6]||(e[6]=a=>(r.store.modal=!0,t.$emit("changeBurger"),r.store.bg="bg-bee",r.store.comp="Login")),class:"border-[2px] border-solid border-black rounded-[8px] w-[218px] h-[47px] mt-[5px] mb-[20px] flex justify-center items-center font-ubuntu font-[400] text-[16px] text-[##000000]"},[gm,Ie(j(r.store.langProp.login),1)])])),r.store.loggedIn&&!t.$route.path.includes("Personal")?(he(),we("div",mm,[ee(o,{to:`/${r.lang}/PersonalArea/${r.store.uid}`,class:"border-[2px] border-solid border-black rounded-[8px] my-4 w-[218px] h-[47px] flex justify-center items-center font-ubuntu font-[400] text-[16px] text-[##000000]"},{default:Le(()=>[_m,Ie(j(r.store.langProp.profile),1)]),_:1},8,["to"])])):nt("",!0),m("div",bm,[vm,m("p",ym,j(r.store.langProp.address+" 770033 "+r.store.langProp.kyrgyzstan+","),1),m("p",wm,j(r.store.langProp.street),1)])])}const Im=at(im,[["render",Em]]),xm="/assets/drawing-9a7198cf.svg",Tm="/assets/CraftHoney-0d412893.svg",lc="/assets/shopping_cart-809c2612.svg",km="/assets/menu-694c5a76.svg",cc="/assets/account_circle-229cba33.svg",Sm={beforeRouteEnter(t,e){},data(){return{burgerMenu:!1,products:"/${store.lang}/Products",store:ce()}},methods:{changeBurger(){this.burgerMenu=!1}},components:{Contacts:oc,Burger:Im}},Cm={class:"grid grid-flow-col gap-[40px] items-center"},Pm=m("img",{class:"self-center w-[60px] inline",src:xm},null,-1),Rm=m("img",{class:"ml-[10px] self-center w-[120px] inline",src:Tm},null,-1),Am={key:0,class:"text-xl [&>a]:mr-[30px] max-[1200px]:hidden"},Om={class:"grid grid-flow-col gap-[20px] min-[1201px]:hidden"},Nm={class:"self-center"},Dm={class:"relative"},Mm=m("img",{class:"w-[22px]",src:lc,alt:""},null,-1),Lm={key:0,class:"absolute h-[18px] w-[18px] top-[-9px] left-[12px] rounded-full bg-red-600 flex justify-center align-center text-white"},Um={class:"text-[12px]"},$m={class:"self-center"},Fm={class:"grid grid-flow-col gap-[40px] items-center max-[1200px]:hidden"},Bm={key:0,class:"flex items-center"},jm=m("img",{class:"mr-[10px] w-[24px]",src:cc},null,-1),Hm={key:1,class:"flex items-center"},Vm=m("img",{class:"mr-[10px] w-[24px]",src:cc},null,-1),Wm={class:"relative"},zm=m("img",{class:"w-[22px]",src:lc,alt:""},null,-1),Km={key:0,class:"absolute h-[18px] w-[18px] top-[-9px] left-[12px] rounded-full bg-red-600 flex justify-center align-center text-white"},qm={class:"text-[12px]"},Gm={class:"text-xl [&_*]:text-center"},Jm={selected:"",disabled:"",hidden:""},Ym=_i('<div class="grid grid-flow-col gap-[10px]"><a href="https://wa.me/79146089174" target="_blank"><img src="'+Oi+'" alt=""></a><a href="https://t.me/+996779454233" target="_blank"><img src="'+Ai+'" alt=""></a><a href="https://www.instagram.com/crafthoney.kg" target="_blank"><img src="'+Ni+'" alt=""></a></div>',1);function Xm(t,e,n,s,r,i){const o=Xt("router-link"),a=Xt("Burger");return he(),we("header",{class:gn([{"border-black border-b-[3px] pb-[20px]":!t.$route.path.includes("Home")},"bg-white flex justify-between mt-[10px] pb-[10px] max-[800px]:grid-cols-1"])},[m("div",Cm,[m("div",null,[ee(o,{class:"flex max-w-fit",to:`/${r.store.lang}/Home`},{default:Le(()=>[Pm,Rm]),_:1},8,["to"])]),t.$route.path.includes("Home")?nt("",!0):(he(),we("div",Am,[ee(o,{class:"hover:text-amber-700 hover:underline underline-offset-4",to:"products"},{default:Le(()=>{var l,c;return[Ie(j((c=(l=r.store)==null?void 0:l.langProp)==null?void 0:c.catalogue),1)]}),_:1}),ee(o,{class:"hover:text-amber-700 hover:underline underline-offset-4",to:`/${r.store.lang}/About`},{default:Le(()=>[Ie(j(r.store.langProp.about),1)]),_:1},8,["to"]),ee(o,{class:"hover:text-amber-700 hover:underline underline-offset-4",to:`/${r.store.lang}/Blog`},{default:Le(()=>[Ie(j(r.store.langProp.blog),1)]),_:1},8,["to"]),m("button",{class:"hover:text-amber-700 hover:underline underline-offset-4",onClick:e[0]||(e[0]=l=>(r.store.modal=!0,r.store.comp="Contacts",r.store.bg="bg-white"))},j(r.store.langProp.contacts),1)]))]),m("div",Om,[m("div",Nm,[ee(o,{to:`/${r.store.lang}/Checkout`},{default:Le(()=>[m("div",Dm,[Mm,Object.keys(r.store.cart).length?(he(),we("div",Lm,[m("span",Um,j(Object.keys(r.store.cart).length),1)])):nt("",!0)])]),_:1},8,["to"])]),m("div",$m,[m("img",{onClick:e[1]||(e[1]=l=>r.burgerMenu=!0),class:"justify-self-center self-center hover:cursor-pointer",src:km})])]),m("div",Fm,[!r.store.loggedIn&&!t.$route.path.includes("Personal")?(he(),we("div",Bm,[jm,m("button",{class:"text-xl text-center hover:text-amber-700 hover:underline underline-offset-4",onClick:e[2]||(e[2]=l=>(r.store.modal=!0,r.store.comp="Login",r.store.bg="bg-bee"))},j(r.store.langProp.login),1)])):nt("",!0),r.store.loggedIn&&!t.$route.path.includes("Personal")?(he(),we("div",Hm,[Vm,ee(o,{class:"text-xl text-center hover:text-amber-700 hover:underline underline-offset-4",to:`/${r.store.lang}/PersonalArea/${r.store.uid}`},{default:Le(()=>[Ie(j(r.store.langProp.profile),1)]),_:1},8,["to"])])):nt("",!0),m("div",null,[ee(o,{to:`/${r.store.lang}/Checkout`},{default:Le(()=>[m("div",Wm,[zm,Object.keys(r.store.cart).length?(he(),we("div",Km,[m("span",qm,j(Object.keys(r.store.cart).length),1)])):nt("",!0)])]),_:1},8,["to"])]),m("div",null,[m("p",Gm,[Ie(j(r.store.langProp.lang)+": ",1),ye(m("select",{onChange:e[6]||(e[6]=l=>t.$router.push(`/${r.store.lang}/${t.$route.path.slice(4,t.$route.path.length)}`)),class:"ml-[8px] h-[32px] w-[56px] bg-[#ffcc00] rounded-xl hover:cursor-pointer hover:text-amber-700 hover:bg-amber-200 underline-offset-4",name:"store.lang",id:"","onUpdate:modelValue":e[7]||(e[7]=l=>r.store.lang=l)},[m("option",Jm,j(r.store.lang.toUpperCase()),1),m("option",{onClick:e[3]||(e[3]=l=>r.store.lang="ru"),value:"ru"},"RU"),m("option",{onClick:e[4]||(e[4]=l=>r.store.lang="en"),value:"en"},"EN"),m("option",{onClick:e[5]||(e[5]=l=>r.store.lang="kg"),value:"kg"},"KG")],544),[[fl,r.store.lang]])])]),Ym]),m("div",{class:gn(["right-[0px] top-0 overflow-hidden transition-all duration-500 ease-in-out z-50 absolute h-screen bg-[#DAE2E2]",r.burgerMenu?"w-[330px]":"w-[0px]"])},[ee(a,{onChangeBurger:i.changeBurger},null,8,["onChangeBurger"])],2)],2)}const Qm=at(Sm,[["render",Xm]]),Zm={props:{buttonName:String},data:()=>({feedback:!1,name:"",mail:"",phone:"",message:"",store:ce()}),methods:{showFeedback(){this.feedback=!0},closeModal(){this.feedback=!1},cleanForm(){},clearInput(){this.name="",this.phone="",this.mail="",this.message=""},handleInput(){this.phone=this.phone.replace(/[^0-9+]/g,"")},sendMail(){fetch(`/api/mail/?name=${this.name}&mail=${this.mail}&phone=${this.phone}&message=${this.message}`)}}},e_={class:"grid grid-flow-row gap-y-[20px] mb-[60px] [&_input]:h-[60px]"},t_={class:"grid grid-cols-[max-content_auto_max-content] text-[40px] max-[700px]:grid-cols-1"},n_=m("span",{class:"justify-self-center max-[700px]:hidden"},"|",-1),s_={class:"bg-gray-200 font-bold font-roboto rounded-[10px] px-2 text-black text-center max-[550px]:text-2xl"},r_=["placeholder"],i_={class:"grid grid-cols-2 gap-[20px]"},o_=["placeholder"],a_={class:"grid grid-cols-2 gap-[20px] [&>*]:h-[50px]"},l_=["disabled"];function c_(t,e,n,s,r,i){return he(),we("div",e_,[m("div",t_,[m("button",{onClick:e[0]||(e[0]=o=>t.store.comp="Contacts"),class:"bg-[#EAAD02] rounded-[10px] px-2 text-white max-[550px]:text-2xl"},j(t.store.langProp.contacts),1),n_,m("span",s_,j(t.store.langProp.feedback),1)]),m("div",null,[ye(m("input",{"onUpdate:modelValue":e[1]||(e[1]=o=>t.name=o),class:"border-solid border-2 rounded-[4px] border-gray-400 text-center w-full",type:"text",placeholder:t.store.langProp.yourname},null,8,r_),[[ft,t.name]])]),m("div",i_,[ye(m("input",{"onUpdate:modelValue":e[2]||(e[2]=o=>t.mail=o),class:"border-solid border-2 rounded-[4px] border-gray-400 px-[10px]",type:"text",placeholder:"Email"},null,512),[[ft,t.mail]]),ye(m("input",{onInput:e[3]||(e[3]=(...o)=>i.handleInput&&i.handleInput(...o)),"onUpdate:modelValue":e[4]||(e[4]=o=>t.phone=o),class:"border-solid border-2 rounded-[4px] border-gray-400 px-[10px]",placeholder:t.store.langProp.telephone},null,40,o_),[[ft,t.phone]])]),m("div",null,[ye(m("textarea",{"onUpdate:modelValue":e[5]||(e[5]=o=>t.message=o),class:"border-solid border-2 rounded-[4px] border-gray-400 h-[139px] px-[10px] py-[10px] w-full",placeholder:"Сообщение",name:"",id:""},null,512),[[ft,t.message]])]),m("div",a_,[m("button",{onClick:e[6]||(e[6]=(...o)=>i.sendMail&&i.sendMail(...o)),disabled:t.name.length<=2||t.mail.length<=5||t.phone.length<=7||t.message.length<=10,class:"bg-[#EAAD02] text-white rounded-[5px] disabled:opacity-50"},j(t.store.langProp.send),9,l_),m("button",{onClick:e[7]||(e[7]=(...o)=>i.clearInput&&i.clearInput(...o)),class:"bg-[#02020233] rounded-[5px]"},j(t.store.langProp.reset),1)])])}const uc=at(Zm,[["render",c_]]),u_="/assets/call-65c88a38.svg",f_={data(){return{store:ce()}},components:{Feedback:uc}},d_={class:"bg-white flex justify-center my-[1vh] w-full"},h_={class:"self-center"},p_=m("img",{class:"inline ml-2",src:u_},null,-1);function g_(t,e,n,s,r,i){return he(),we("footer",d_,[m("div",h_,[m("button",{onClick:e[0]||(e[0]=o=>(r.store.modal=!0,r.store.comp="Feedback",r.store.bg="bg-gray-200")),class:"underline text-[20px]"},"Обратная связь"),p_])])}const m_=at(f_,[["render",g_]]),__="/assets/Vector-9ca58fbf.svg",Di="/assets/visibility_on-0c36d6bb.svg",Mi="/assets/visibility_off-e6686e60.svg",b_={props:{buttonName:String},data(){return{email:"",password:"",store:ce(),showPassword:!1}},methods:{loginGoogle(){const t=En(),e=new Re;rc(t,e).then(n=>{Re.credentialFromResult(n).accessToken;const r=n.user;this.store.modal=!1,fetch("/api/users",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({1:r.uid})}),this.store.getCart(),this.store.name=r.displayName,this.$router.push(`/${this.store.lang}/PersonalArea/${r.uid}`)}).catch(n=>{n.code,n.message,Re.credentialFromError(n)})},async login(){const t=En();Ep(t,this.email,this.password).then(e=>{const n=e.user;console.log(n),this.store.modal=!1,this.store.getCart(),this.store.name=n.displayName,this.$router.push(`/${this.store.lang}/PersonalArea/${n.uid}`)}).catch(e=>{e.code,e.message})},eyechange(){this.showPassword=!this.showPassword}}},v_={class:"h-[500px] grid grid-cols-2 max-[450px]:grid-cols-1 [&_*]:font-roboto [&_input]:pl-[8px]"},y_={class:"grid auto-rows-min gap-[20px]"},w_={class:"text-[30px] flex justify-center"},E_={class:"bg-gray-200 rounded-[10px] px-2 text-black font-roboto"},I_=m("span",{class:"mx-2"},"|",-1),x_=m("img",{class:"mr-[8px]",src:__},null,-1),T_=["placeholder"],k_={class:"relative"},S_=["type","placeholder"],C_={src:Di,alt:""},P_={src:Mi,alt:""},R_=["disabled"],A_={class:"text-center"};function O_(t,e,n,s,r,i){const o=Xt("router-link");return he(),we("div",v_,[m("div",y_,[m("div",w_,[m("span",E_,j(r.store.langProp.login),1),I_,m("button",{onClick:e[0]||(e[0]=a=>r.store.comp="Register"),class:"bg-[#EAAD02] rounded-[10px] px-2 text-white font-roboto hover:text-amber-700"},j(r.store.langProp.registration),1)]),m("button",{onClick:e[1]||(e[1]=(...a)=>i.loginGoogle&&i.loginGoogle(...a)),class:"border-2 flex items-center justify-center rounded-[3px] border-none bg-gray-100 text-black h-[45px] hover:text-amber-700"},[x_,Ie(j(r.store.langProp.loginwithgoogle),1)]),ye(m("input",{"onUpdate:modelValue":e[2]||(e[2]=a=>r.email=a),class:"bg-[url('@/assets/mail(1).svg')] bg-no-repeat bg-[left_16px_top_12px] indent-[40px] px-[8px] border-2 rounded-[3px] h-[45px] border-gray-400 font-roboto",type:"email",placeholder:r.store.langProp.enteremail},null,8,T_),[[ft,r.email]]),m("div",k_,[ye(m("input",{"onUpdate:modelValue":e[3]||(e[3]=a=>r.password=a),class:"bg-[url('@/assets/lock.svg')] bg-no-repeat bg-[left_16px_top_9px] indent-[40px] w-full px-[8px] flex items-center font-roboto border-2 rounded-[3px] h-[45px] border-gray-400",required:"",type:r.showPassword?"text":"password",placeholder:r.store.langProp.enterpassword},null,8,S_),[[$r,r.password]]),m("button",{onClick:e[4]||(e[4]=(...a)=>i.eyechange&&i.eyechange(...a)),class:"buttonPass absolute right-[30px] top-0 bottom-0"},[ye(m("img",C_,null,512),[[Wt,r.showPassword]]),ye(m("img",P_,null,512),[[Wt,!r.showPassword]])])]),ee(o,{to:"/",class:"text-blue-500 px-[10px] flex justify-end hover:text-amber-700 hover:underline underline-offset-4"},{default:Le(()=>[Ie(j(r.store.langProp.forgotyourpassword),1)]),_:1}),m("button",{onClick:e[5]||(e[5]=(...a)=>i.login&&i.login(...a)),disabled:r.email.length<=2||r.password.length<=1,class:"bg-[#EAAD02] border-2 border-none rounded-[3px] text-white h-[45px] disabled:opacity-50"},j(r.store.langProp.login),9,R_),m("p",A_,[Ie(j(r.store.langProp.donthaveaccount),1),m("button",{onClick:e[6]||(e[6]=a=>r.store.comp="Register"),class:"ml-[8px] text-blue-500 underline hover:text-amber-700"},j(r.store.langProp.createaccount),1)])])])}const N_=at(b_,[["render",O_]]),D_="/assets/Vector-9ca58fbf.svg",M_={data(){return{showModal:!1,name:"",password:"",password2:"",email:"",showPassword:!1,passwordMinLength:!1,MinLength:5,eyepass:"src/assets/visibility_off.svg",store:ce()}},methods:{loginGoogle(){const t=En(),e=new Re;rc(t,e).then(n=>{Re.credentialFromResult(n).accessToken;const r=n.user;console.log(r),this.store.modal=!1,fetch("/api/users",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({1:r.uid})}),this.store.getCart(),this.store.name=r.displayName,this.$router.push(`/${this.store.lang}/PersonalArea/${r.uid}`)}).catch(n=>{n.code,n.message,Re.credentialFromError(n)})},async register(){const t=En();wp(t,this.email,this.password).then(e=>{const n=e.user;this.store.comp="Login",fetch("/api/users",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({1:n.uid})}),xp(t.currentUser,{displayName:this.name})}).catch(e=>{e.code,e.message})},eyechange(){this.showPassword=!this.showPassword,this.eyepass=="src/assets/visibility_off.svg"?this.eyepass="src/assets/visibility_ON.svg":this.eyepass="src/assets/visibility_off.svg"}}},L_={class:"h-[500px] grid grid-cols-2 max-[450px]:grid-cols-1 [&_*]:font-roboto [&_input]:pl-[8px]"},U_={class:"grid auto-rows-min gap-[20px]"},$_={class:"text-[30px] h-[45px] flex justify-center"},F_=m("span",{class:"mx-2"},"|",-1),B_={class:"bg-gray-300 rounded-[10px] px-2 text-black"},j_=m("img",{class:"mr-[8px]",src:D_},null,-1),H_=["placeholder"],V_=["placeholder"],W_={class:"relative"},z_=["type","placeholder"],K_={src:Di,alt:""},q_={src:Mi,alt:""},G_={class:"relative"},J_=["type","placeholder"],Y_={src:Di,alt:""},X_={src:Mi,alt:""},Q_={key:0,class:"text-red-500 font-roboto leading-[2px]"},Z_=["disabled"],eb={class:"text-center"};function tb(t,e,n,s,r,i){return he(),we("div",L_,[m("div",U_,[m("div",$_,[m("button",{onClick:e[0]||(e[0]=o=>r.store.comp="Login"),class:"bg-[#EAAD02] rounded-[10px] px-2 text-white hover:text-amber-700"},j(r.store.langProp.login),1),F_,m("span",B_,j(r.store.langProp.registration),1)]),m("button",{onClick:e[1]||(e[1]=(...o)=>i.loginGoogle&&i.loginGoogle(...o)),class:"border-2 flex items-center justify-center rounded-[3px] border-none bg-gray-100 text-black h-[45px] hover:text-amber-700"},[j_,Ie(" "+j(r.store.langProp.loginwithgoogle),1)]),ye(m("input",{"onUpdate:modelValue":e[2]||(e[2]=o=>r.name=o),class:"bg-[url('@/assets/person.svg')] bg-no-repeat bg-[left_16px_top_12px] indent-[40px] px-[8px] font-roboto border-2 rounded-[3px] h-[45px] border-gray-400",type:"text",placeholder:r.store.langProp.username},null,8,H_),[[ft,r.name]]),ye(m("input",{"onUpdate:modelValue":e[3]||(e[3]=o=>r.email=o),class:"bg-[url('@/assets/mail(1).svg')] bg-no-repeat bg-[left_16px_top_12px] indent-[40px] px-[8px] font-roboto border-2 rounded-[3px] h-[45px] border-gray-400",type:"email",placeholder:r.store.langProp.enteremail},null,8,V_),[[ft,r.email]]),m("div",W_,[ye(m("input",{"onUpdate:modelValue":e[4]||(e[4]=o=>r.password=o),onFocus:e[5]||(e[5]=o=>r.passwordMinLength=!0),class:"bg-[url('@/assets/lock.svg')] bg-no-repeat bg-[left_16px_top_9px] indent-[40px] px-[8px] w-full font-roboto border-2 rounded-[3px] h-[45px] border-gray-400",required:"",type:r.showPassword?"text":"password",placeholder:r.store.langProp.password},null,40,z_),[[$r,r.password]]),m("button",{onClick:e[6]||(e[6]=(...o)=>i.eyechange&&i.eyechange(...o)),class:"buttonPass absolute right-[30px] top-0 bottom-0"},[ye(m("img",K_,null,512),[[Wt,r.showPassword]]),ye(m("img",q_,null,512),[[Wt,!r.showPassword]])])]),m("div",G_,[ye(m("input",{"onUpdate:modelValue":e[7]||(e[7]=o=>r.password2=o),class:"bg-[url('@/assets/lock.svg')] bg-no-repeat bg-[left_16px_top_9px] indent-[40px] w-full px-[8px] flex items-center font-roboto border-2 rounded-[3px] h-[45px] border-gray-400",required:"",type:r.showPassword?"text":"password",placeholder:r.store.langProp.confirmthepassword},null,8,J_),[[$r,r.password2]]),m("button",{onClick:e[8]||(e[8]=o=>r.showPassword=!r.showPassword),class:"buttonPass absolute right-[30px] top-0 bottom-0"},[ye(m("img",Y_,null,512),[[Wt,r.showPassword]]),ye(m("img",X_,null,512),[[Wt,!r.showPassword]])])]),r.password2!=r.password?(he(),we("div",Q_,j(r.store.langProp.passwordmismatch),1)):nt("",!0),ye(m("div",{class:"text-red-500 font-roboto leading-[2px]"},j(r.store.langProp.minimumnumberofsymbols)+" - "+j(r.MinLength),513),[[Wt,r.passwordMinLength&&r.password.length<=5]]),m("button",{onClick:e[9]||(e[9]=(...o)=>i.register&&i.register(...o)),disabled:r.name.length<=2||r.password.length<=5||r.email.length<=5||r.password!==r.password2,class:"bg-[#EAAD02] border-2 border-none rounded-[3px] text-white h-[45px] disabled:opacity-50"},j(r.store.langProp.registration),9,Z_),m("p",eb,[Ie(j(r.store.langProp.doyouhaveaccount),1),m("button",{onClick:e[10]||(e[10]=o=>r.store.comp="Login"),class:"ml-[8px] text-blue-500 underline hover:text-amber-700"},j(r.store.langProp.login),1)])])])}const nb=at(M_,[["render",tb]]),sb={data(){return{store:ce()}},components:{Contacts:oc,Feedback:uc,Login:N_,Register:nb}},rb={key:0,class:"fixed z-[12] inset-0 flex justify-center items-center"},ib={class:"p-2 text-right"},ob=m("strong",null,"X",-1),ab=[ob];function lb(t,e,n,s,r,i){return r.store.modal?(he(),we("div",rb,[r.store.modal?(he(),we("div",{key:0,onClick:e[0]||(e[0]=o=>r.store.modal=!1),class:"fixed z-[11] inset-0 flex justify-center bg-black bg-opacity-80"})):nt("",!0),m("div",{class:gn([r.store.bg,"max-h-screen bg-cover bg-no-repeat grid rounded-[10px] z-[11]"])},[m("div",ib,[m("button",{onClick:e[1]||(e[1]=o=>r.store.modal=!1),class:"w-10 h-10 focus:outline-none text-[29px]"},ab)]),(he(),Qs(zu(r.store.comp),{class:"mx-20 mb-10 max-[450px]:mx-[10px]"}))],2)])):nt("",!0)}const cb=at(sb,[["render",lb]]),ub={components:{Header:Qm,Footer:m_,LayoutModal:cb}},fb={class:"h-screen min-h-[700px] overflow-x-hidden px-[40px] grid grid-rows-[min-content_auto] max-w-screen max-[800px]:px-[20px] max-[400px]:px-[4px]"};function db(t,e,n,s,r,i){const o=Xt("LayoutModal"),a=Xt("Header");return he(),we(Ue,null,[ee(o),m("div",fb,[ee(a),Ku(t.$slots,"default")])],64)}const hb=at(ub,[["render",db]]),pb={};function gb(t,e){const n=Xt("RouterView");return he(),Qs(n)}const mb=at(pb,[["render",gb]]),_b="modulepreload",bb=function(t){return"/"+t},Ko={},$t=function(e,n,s){if(!n||n.length===0)return e();const r=document.getElementsByTagName("link");return Promise.all(n.map(i=>{if(i=bb(i),i in Ko)return;Ko[i]=!0;const o=i.endsWith(".css"),a=o?'[rel="stylesheet"]':"";if(!!s)for(let f=r.length-1;f>=0;f--){const h=r[f];if(h.href===i&&(!o||h.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${i}"]${a}`))return;const c=document.createElement("link");if(c.rel=o?"stylesheet":_b,o||(c.as="script",c.crossOrigin=""),c.href=i,document.head.appendChild(c),o)return new Promise((f,h)=>{c.addEventListener("load",f),c.addEventListener("error",()=>h(new Error(`Unable to preload CSS for ${i}`)))})})).then(()=>e())};/*!
  * vue-router v4.1.6
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
  */const an=typeof window<"u";function vb(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const te=Object.assign;function wr(t,e){const n={};for(const s in e){const r=e[s];n[s]=Ye(r)?r.map(t):t(r)}return n}const zn=()=>{},Ye=Array.isArray,yb=/\/$/,wb=t=>t.replace(yb,"");function Er(t,e,n="/"){let s,r={},i="",o="";const a=e.indexOf("#");let l=e.indexOf("?");return a<l&&a>=0&&(l=-1),l>-1&&(s=e.slice(0,l),i=e.slice(l+1,a>-1?a:e.length),r=t(i)),a>-1&&(s=s||e.slice(0,a),o=e.slice(a,e.length)),s=Tb(s??e,n),{fullPath:s+(i&&"?")+i+o,path:s,query:r,hash:o}}function Eb(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function qo(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function Ib(t,e,n){const s=e.matched.length-1,r=n.matched.length-1;return s>-1&&s===r&&In(e.matched[s],n.matched[r])&&fc(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function In(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function fc(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!xb(t[n],e[n]))return!1;return!0}function xb(t,e){return Ye(t)?Go(t,e):Ye(e)?Go(e,t):t===e}function Go(t,e){return Ye(e)?t.length===e.length&&t.every((n,s)=>n===e[s]):t.length===1&&t[0]===e}function Tb(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),s=t.split("/");let r=n.length-1,i,o;for(i=0;i<s.length;i++)if(o=s[i],o!==".")if(o==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(i-(i===s.length?1:0)).join("/")}var is;(function(t){t.pop="pop",t.push="push"})(is||(is={}));var Kn;(function(t){t.back="back",t.forward="forward",t.unknown=""})(Kn||(Kn={}));function kb(t){if(!t)if(an){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),wb(t)}const Sb=/^[^#]+#/;function Cb(t,e){return t.replace(Sb,"#")+e}function Pb(t,e){const n=document.documentElement.getBoundingClientRect(),s=t.getBoundingClientRect();return{behavior:e.behavior,left:s.left-n.left-(e.left||0),top:s.top-n.top-(e.top||0)}}const or=()=>({left:window.pageXOffset,top:window.pageYOffset});function Rb(t){let e;if("el"in t){const n=t.el,s=typeof n=="string"&&n.startsWith("#"),r=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!r)return;e=Pb(r,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Jo(t,e){return(history.state?history.state.position-e:-1)+t}const Gr=new Map;function Ab(t,e){Gr.set(t,e)}function Ob(t){const e=Gr.get(t);return Gr.delete(t),e}let Nb=()=>location.protocol+"//"+location.host;function dc(t,e){const{pathname:n,search:s,hash:r}=e,i=t.indexOf("#");if(i>-1){let a=r.includes(t.slice(i))?t.slice(i).length:1,l=r.slice(a);return l[0]!=="/"&&(l="/"+l),qo(l,"")}return qo(n,t)+s+r}function Db(t,e,n,s){let r=[],i=[],o=null;const a=({state:p})=>{const b=dc(t,location),x=n.value,k=e.value;let U=0;if(p){if(n.value=b,e.value=p,o&&o===x){o=null;return}U=k?p.position-k.position:0}else s(b);r.forEach(R=>{R(n.value,x,{delta:U,type:is.pop,direction:U?U>0?Kn.forward:Kn.back:Kn.unknown})})};function l(){o=n.value}function c(p){r.push(p);const b=()=>{const x=r.indexOf(p);x>-1&&r.splice(x,1)};return i.push(b),b}function f(){const{history:p}=window;p.state&&p.replaceState(te({},p.state,{scroll:or()}),"")}function h(){for(const p of i)p();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",f)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",f),{pauseListeners:l,listen:c,destroy:h}}function Yo(t,e,n,s=!1,r=!1){return{back:t,current:e,forward:n,replaced:s,position:window.history.length,scroll:r?or():null}}function Mb(t){const{history:e,location:n}=window,s={value:dc(t,n)},r={value:e.state};r.value||i(s.value,{back:null,current:s.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(l,c,f){const h=t.indexOf("#"),p=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+l:Nb()+t+l;try{e[f?"replaceState":"pushState"](c,"",p),r.value=c}catch(b){console.error(b),n[f?"replace":"assign"](p)}}function o(l,c){const f=te({},e.state,Yo(r.value.back,l,r.value.forward,!0),c,{position:r.value.position});i(l,f,!0),s.value=l}function a(l,c){const f=te({},r.value,e.state,{forward:l,scroll:or()});i(f.current,f,!0);const h=te({},Yo(s.value,l,null),{position:f.position+1},c);i(l,h,!1),s.value=l}return{location:s,state:r,push:a,replace:o}}function Lb(t){t=kb(t);const e=Mb(t),n=Db(t,e.state,e.location,e.replace);function s(i,o=!0){o||n.pauseListeners(),history.go(i)}const r=te({location:"",base:t,go:s,createHref:Cb.bind(null,t)},e,n);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>e.state.value}),r}function Ub(t){return typeof t=="string"||t&&typeof t=="object"}function hc(t){return typeof t=="string"||typeof t=="symbol"}const vt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},pc=Symbol("");var Xo;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Xo||(Xo={}));function xn(t,e){return te(new Error,{type:t,[pc]:!0},e)}function lt(t,e){return t instanceof Error&&pc in t&&(e==null||!!(t.type&e))}const Qo="[^/]+?",$b={sensitive:!1,strict:!1,start:!0,end:!0},Fb=/[.+*?^${}()[\]/\\]/g;function Bb(t,e){const n=te({},$b,e),s=[];let r=n.start?"^":"";const i=[];for(const c of t){const f=c.length?[]:[90];n.strict&&!c.length&&(r+="/");for(let h=0;h<c.length;h++){const p=c[h];let b=40+(n.sensitive?.25:0);if(p.type===0)h||(r+="/"),r+=p.value.replace(Fb,"\\$&"),b+=40;else if(p.type===1){const{value:x,repeatable:k,optional:U,regexp:R}=p;i.push({name:x,repeatable:k,optional:U});const B=R||Qo;if(B!==Qo){b+=10;try{new RegExp(`(${B})`)}catch(W){throw new Error(`Invalid custom RegExp for param "${x}" (${B}): `+W.message)}}let O=k?`((?:${B})(?:/(?:${B}))*)`:`(${B})`;h||(O=U&&c.length<2?`(?:/${O})`:"/"+O),U&&(O+="?"),r+=O,b+=20,U&&(b+=-8),k&&(b+=-20),B===".*"&&(b+=-50)}f.push(b)}s.push(f)}if(n.strict&&n.end){const c=s.length-1;s[c][s[c].length-1]+=.7000000000000001}n.strict||(r+="/?"),n.end?r+="$":n.strict&&(r+="(?:/|$)");const o=new RegExp(r,n.sensitive?"":"i");function a(c){const f=c.match(o),h={};if(!f)return null;for(let p=1;p<f.length;p++){const b=f[p]||"",x=i[p-1];h[x.name]=b&&x.repeatable?b.split("/"):b}return h}function l(c){let f="",h=!1;for(const p of t){(!h||!f.endsWith("/"))&&(f+="/"),h=!1;for(const b of p)if(b.type===0)f+=b.value;else if(b.type===1){const{value:x,repeatable:k,optional:U}=b,R=x in c?c[x]:"";if(Ye(R)&&!k)throw new Error(`Provided param "${x}" is an array but it is not repeatable (* or + modifiers)`);const B=Ye(R)?R.join("/"):R;if(!B)if(U)p.length<2&&(f.endsWith("/")?f=f.slice(0,-1):h=!0);else throw new Error(`Missing required param "${x}"`);f+=B}}return f||"/"}return{re:o,score:s,keys:i,parse:a,stringify:l}}function jb(t,e){let n=0;for(;n<t.length&&n<e.length;){const s=e[n]-t[n];if(s)return s;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Hb(t,e){let n=0;const s=t.score,r=e.score;for(;n<s.length&&n<r.length;){const i=jb(s[n],r[n]);if(i)return i;n++}if(Math.abs(r.length-s.length)===1){if(Zo(s))return 1;if(Zo(r))return-1}return r.length-s.length}function Zo(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Vb={type:0,value:""},Wb=/[a-zA-Z0-9_]/;function zb(t){if(!t)return[[]];if(t==="/")return[[Vb]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(b){throw new Error(`ERR (${n})/"${c}": ${b}`)}let n=0,s=n;const r=[];let i;function o(){i&&r.push(i),i=[]}let a=0,l,c="",f="";function h(){c&&(n===0?i.push({type:0,value:c}):n===1||n===2||n===3?(i.length>1&&(l==="*"||l==="+")&&e(`A repeatable param (${c}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:c,regexp:f,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):e("Invalid state to consume buffer"),c="")}function p(){c+=l}for(;a<t.length;){if(l=t[a++],l==="\\"&&n!==2){s=n,n=4;continue}switch(n){case 0:l==="/"?(c&&h(),o()):l===":"?(h(),n=1):p();break;case 4:p(),n=s;break;case 1:l==="("?n=2:Wb.test(l)?p():(h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--);break;case 2:l===")"?f[f.length-1]=="\\"?f=f.slice(0,-1)+l:n=3:f+=l;break;case 3:h(),n=0,l!=="*"&&l!=="?"&&l!=="+"&&a--,f="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${c}"`),h(),o(),r}function Kb(t,e,n){const s=Bb(zb(t.path),n),r=te(s,{record:t,parent:e,children:[],alias:[]});return e&&!r.record.aliasOf==!e.record.aliasOf&&e.children.push(r),r}function qb(t,e){const n=[],s=new Map;e=na({strict:!1,end:!0,sensitive:!1},e);function r(f){return s.get(f)}function i(f,h,p){const b=!p,x=Gb(f);x.aliasOf=p&&p.record;const k=na(e,f),U=[x];if("alias"in f){const O=typeof f.alias=="string"?[f.alias]:f.alias;for(const W of O)U.push(te({},x,{components:p?p.record.components:x.components,path:W,aliasOf:p?p.record:x}))}let R,B;for(const O of U){const{path:W}=O;if(h&&W[0]!=="/"){const K=h.record.path,re=K[K.length-1]==="/"?"":"/";O.path=h.record.path+(W&&re+W)}if(R=Kb(O,h,k),p?p.alias.push(R):(B=B||R,B!==R&&B.alias.push(R),b&&f.name&&!ta(R)&&o(f.name)),x.children){const K=x.children;for(let re=0;re<K.length;re++)i(K[re],R,p&&p.children[re])}p=p||R,(R.record.components&&Object.keys(R.record.components).length||R.record.name||R.record.redirect)&&l(R)}return B?()=>{o(B)}:zn}function o(f){if(hc(f)){const h=s.get(f);h&&(s.delete(f),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(f);h>-1&&(n.splice(h,1),f.record.name&&s.delete(f.record.name),f.children.forEach(o),f.alias.forEach(o))}}function a(){return n}function l(f){let h=0;for(;h<n.length&&Hb(f,n[h])>=0&&(f.record.path!==n[h].record.path||!gc(f,n[h]));)h++;n.splice(h,0,f),f.record.name&&!ta(f)&&s.set(f.record.name,f)}function c(f,h){let p,b={},x,k;if("name"in f&&f.name){if(p=s.get(f.name),!p)throw xn(1,{location:f});k=p.record.name,b=te(ea(h.params,p.keys.filter(B=>!B.optional).map(B=>B.name)),f.params&&ea(f.params,p.keys.map(B=>B.name))),x=p.stringify(b)}else if("path"in f)x=f.path,p=n.find(B=>B.re.test(x)),p&&(b=p.parse(x),k=p.record.name);else{if(p=h.name?s.get(h.name):n.find(B=>B.re.test(h.path)),!p)throw xn(1,{location:f,currentLocation:h});k=p.record.name,b=te({},h.params,f.params),x=p.stringify(b)}const U=[];let R=p;for(;R;)U.unshift(R.record),R=R.parent;return{name:k,path:x,params:b,matched:U,meta:Yb(U)}}return t.forEach(f=>i(f)),{addRoute:i,resolve:c,removeRoute:o,getRoutes:a,getRecordMatcher:r}}function ea(t,e){const n={};for(const s of e)s in t&&(n[s]=t[s]);return n}function Gb(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:Jb(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function Jb(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const s in t.components)e[s]=typeof n=="boolean"?n:n[s];return e}function ta(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function Yb(t){return t.reduce((e,n)=>te(e,n.meta),{})}function na(t,e){const n={};for(const s in t)n[s]=s in e?e[s]:t[s];return n}function gc(t,e){return e.children.some(n=>n===t||gc(t,n))}const mc=/#/g,Xb=/&/g,Qb=/\//g,Zb=/=/g,ev=/\?/g,_c=/\+/g,tv=/%5B/g,nv=/%5D/g,bc=/%5E/g,sv=/%60/g,vc=/%7B/g,rv=/%7C/g,yc=/%7D/g,iv=/%20/g;function Li(t){return encodeURI(""+t).replace(rv,"|").replace(tv,"[").replace(nv,"]")}function ov(t){return Li(t).replace(vc,"{").replace(yc,"}").replace(bc,"^")}function Jr(t){return Li(t).replace(_c,"%2B").replace(iv,"+").replace(mc,"%23").replace(Xb,"%26").replace(sv,"`").replace(vc,"{").replace(yc,"}").replace(bc,"^")}function av(t){return Jr(t).replace(Zb,"%3D")}function lv(t){return Li(t).replace(mc,"%23").replace(ev,"%3F")}function cv(t){return t==null?"":lv(t).replace(Qb,"%2F")}function Hs(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function uv(t){const e={};if(t===""||t==="?")return e;const s=(t[0]==="?"?t.slice(1):t).split("&");for(let r=0;r<s.length;++r){const i=s[r].replace(_c," "),o=i.indexOf("="),a=Hs(o<0?i:i.slice(0,o)),l=o<0?null:Hs(i.slice(o+1));if(a in e){let c=e[a];Ye(c)||(c=e[a]=[c]),c.push(l)}else e[a]=l}return e}function sa(t){let e="";for(let n in t){const s=t[n];if(n=av(n),s==null){s!==void 0&&(e+=(e.length?"&":"")+n);continue}(Ye(s)?s.map(i=>i&&Jr(i)):[s&&Jr(s)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function fv(t){const e={};for(const n in t){const s=t[n];s!==void 0&&(e[n]=Ye(s)?s.map(r=>r==null?null:""+r):s==null?s:""+s)}return e}const dv=Symbol(""),ra=Symbol(""),Ui=Symbol(""),wc=Symbol(""),Yr=Symbol("");function Mn(){let t=[];function e(s){return t.push(s),()=>{const r=t.indexOf(s);r>-1&&t.splice(r,1)}}function n(){t=[]}return{add:e,list:()=>t,reset:n}}function Et(t,e,n,s,r){const i=s&&(s.enterCallbacks[r]=s.enterCallbacks[r]||[]);return()=>new Promise((o,a)=>{const l=h=>{h===!1?a(xn(4,{from:n,to:e})):h instanceof Error?a(h):Ub(h)?a(xn(2,{from:e,to:h})):(i&&s.enterCallbacks[r]===i&&typeof h=="function"&&i.push(h),o())},c=t.call(s&&s.instances[r],e,n,l);let f=Promise.resolve(c);t.length<3&&(f=f.then(l)),f.catch(h=>a(h))})}function Ir(t,e,n,s){const r=[];for(const i of t)for(const o in i.components){let a=i.components[o];if(!(e!=="beforeRouteEnter"&&!i.instances[o]))if(hv(a)){const c=(a.__vccOpts||a)[e];c&&r.push(Et(c,n,s,i,o))}else{let l=a();r.push(()=>l.then(c=>{if(!c)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${i.path}"`));const f=vb(c)?c.default:c;i.components[o]=f;const p=(f.__vccOpts||f)[e];return p&&Et(p,n,s,i,o)()}))}}return r}function hv(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function ia(t){const e=st(Ui),n=st(wc),s=$e(()=>e.resolve(un(t.to))),r=$e(()=>{const{matched:l}=s.value,{length:c}=l,f=l[c-1],h=n.matched;if(!f||!h.length)return-1;const p=h.findIndex(In.bind(null,f));if(p>-1)return p;const b=oa(l[c-2]);return c>1&&oa(f)===b&&h[h.length-1].path!==b?h.findIndex(In.bind(null,l[c-2])):p}),i=$e(()=>r.value>-1&&_v(n.params,s.value.params)),o=$e(()=>r.value>-1&&r.value===n.matched.length-1&&fc(n.params,s.value.params));function a(l={}){return mv(l)?e[un(t.replace)?"replace":"push"](un(t.to)).catch(zn):Promise.resolve()}return{route:s,href:$e(()=>s.value.href),isActive:i,isExactActive:o,navigate:a}}const pv=Va({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:ia,setup(t,{slots:e}){const n=Pn(ia(t)),{options:s}=st(Ui),r=$e(()=>({[aa(t.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[aa(t.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:ul("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:r.value},i)}}}),gv=pv;function mv(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function _v(t,e){for(const n in e){const s=e[n],r=t[n];if(typeof s=="string"){if(s!==r)return!1}else if(!Ye(r)||r.length!==s.length||s.some((i,o)=>i!==r[o]))return!1}return!0}function oa(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const aa=(t,e,n)=>t??e??n,bv=Va({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const s=st(Yr),r=$e(()=>t.route||s.value),i=st(ra,0),o=$e(()=>{let c=un(i);const{matched:f}=r.value;let h;for(;(h=f[c])&&!h.components;)c++;return c}),a=$e(()=>r.value.matched[o.value]);xs(ra,$e(()=>o.value+1)),xs(dv,a),xs(Yr,r);const l=ui();return Fn(()=>[l.value,a.value,t.name],([c,f,h],[p,b,x])=>{f&&(f.instances[h]=c,b&&b!==f&&c&&c===p&&(f.leaveGuards.size||(f.leaveGuards=b.leaveGuards),f.updateGuards.size||(f.updateGuards=b.updateGuards))),c&&f&&(!b||!In(f,b)||!p)&&(f.enterCallbacks[h]||[]).forEach(k=>k(c))},{flush:"post"}),()=>{const c=r.value,f=t.name,h=a.value,p=h&&h.components[f];if(!p)return la(n.default,{Component:p,route:c});const b=h.props[f],x=b?b===!0?c.params:typeof b=="function"?b(c):b:null,U=ul(p,te({},x,e,{onVnodeUnmounted:R=>{R.component.isUnmounted&&(h.instances[f]=null)},ref:l}));return la(n.default,{Component:U,route:c})||U}}});function la(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const vv=bv;function yv(t){const e=qb(t.routes,t),n=t.parseQuery||uv,s=t.stringifyQuery||sa,r=t.history,i=Mn(),o=Mn(),a=Mn(),l=fu(vt);let c=vt;an&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const f=wr.bind(null,v=>""+v),h=wr.bind(null,cv),p=wr.bind(null,Hs);function b(v,P){let S,D;return hc(v)?(S=e.getRecordMatcher(v),D=P):D=v,e.addRoute(D,S)}function x(v){const P=e.getRecordMatcher(v);P&&e.removeRoute(P)}function k(){return e.getRoutes().map(v=>v.record)}function U(v){return!!e.getRecordMatcher(v)}function R(v,P){if(P=te({},P||l.value),typeof v=="string"){const u=Er(n,v,P.path),d=e.resolve({path:u.path},P),g=r.createHref(u.fullPath);return te(u,d,{params:p(d.params),hash:Hs(u.hash),redirectedFrom:void 0,href:g})}let S;if("path"in v)S=te({},v,{path:Er(n,v.path,P.path).path});else{const u=te({},v.params);for(const d in u)u[d]==null&&delete u[d];S=te({},v,{params:h(v.params)}),P.params=h(P.params)}const D=e.resolve(S,P),X=v.hash||"";D.params=f(p(D.params));const fe=Eb(s,te({},v,{hash:ov(X),path:D.path})),q=r.createHref(fe);return te({fullPath:fe,hash:X,query:s===sa?fv(v.query):v.query||{}},D,{redirectedFrom:void 0,href:q})}function B(v){return typeof v=="string"?Er(n,v,l.value.path):te({},v)}function O(v,P){if(c!==v)return xn(8,{from:P,to:v})}function W(v){return z(v)}function K(v){return W(te(B(v),{replace:!0}))}function re(v){const P=v.matched[v.matched.length-1];if(P&&P.redirect){const{redirect:S}=P;let D=typeof S=="function"?S(v):S;return typeof D=="string"&&(D=D.includes("?")||D.includes("#")?D=B(D):{path:D},D.params={}),te({query:v.query,hash:v.hash,params:"path"in D?{}:v.params},D)}}function z(v,P){const S=c=R(v),D=l.value,X=v.state,fe=v.force,q=v.replace===!0,u=re(S);if(u)return z(te(B(u),{state:typeof u=="object"?te({},X,u.state):X,force:fe,replace:q}),P||S);const d=S;d.redirectedFrom=P;let g;return!fe&&Ib(s,D,S)&&(g=xn(16,{to:d,from:D}),Mt(D,D,!0,!1)),(g?Promise.resolve(g):J(d,D)).catch(_=>lt(_)?lt(_,2)?_:We(_):ie(_,d,D)).then(_=>{if(_){if(lt(_,2))return z(te({replace:q},B(_.to),{state:typeof _.to=="object"?te({},X,_.to.state):X,force:fe}),P||d)}else _=de(d,D,!0,q,X);return Y(d,D,_),_})}function A(v,P){const S=O(v,P);return S?Promise.reject(S):Promise.resolve()}function J(v,P){let S;const[D,X,fe]=wv(v,P);S=Ir(D.reverse(),"beforeRouteLeave",v,P);for(const u of D)u.leaveGuards.forEach(d=>{S.push(Et(d,v,P))});const q=A.bind(null,v,P);return S.push(q),on(S).then(()=>{S=[];for(const u of i.list())S.push(Et(u,v,P));return S.push(q),on(S)}).then(()=>{S=Ir(X,"beforeRouteUpdate",v,P);for(const u of X)u.updateGuards.forEach(d=>{S.push(Et(d,v,P))});return S.push(q),on(S)}).then(()=>{S=[];for(const u of v.matched)if(u.beforeEnter&&!P.matched.includes(u))if(Ye(u.beforeEnter))for(const d of u.beforeEnter)S.push(Et(d,v,P));else S.push(Et(u.beforeEnter,v,P));return S.push(q),on(S)}).then(()=>(v.matched.forEach(u=>u.enterCallbacks={}),S=Ir(fe,"beforeRouteEnter",v,P),S.push(q),on(S))).then(()=>{S=[];for(const u of o.list())S.push(Et(u,v,P));return S.push(q),on(S)}).catch(u=>lt(u,8)?u:Promise.reject(u))}function Y(v,P,S){for(const D of a.list())D(v,P,S)}function de(v,P,S,D,X){const fe=O(v,P);if(fe)return fe;const q=P===vt,u=an?history.state:{};S&&(D||q?r.replace(v.fullPath,te({scroll:q&&u&&u.scroll},X)):r.push(v.fullPath,X)),l.value=v,Mt(v,P,S,q),We()}let be;function Ne(){be||(be=r.listen((v,P,S)=>{if(!hs.listening)return;const D=R(v),X=re(D);if(X){z(te(X,{replace:!0}),D).catch(zn);return}c=D;const fe=l.value;an&&Ab(Jo(fe.fullPath,S.delta),or()),J(D,fe).catch(q=>lt(q,12)?q:lt(q,2)?(z(q.to,D).then(u=>{lt(u,20)&&!S.delta&&S.type===is.pop&&r.go(-1,!1)}).catch(zn),Promise.reject()):(S.delta&&r.go(-S.delta,!1),ie(q,D,fe))).then(q=>{q=q||de(D,fe,!1),q&&(S.delta&&!lt(q,8)?r.go(-S.delta,!1):S.type===is.pop&&lt(q,20)&&r.go(-1,!1)),Y(D,fe,q)}).catch(zn)}))}let Ce=Mn(),ve=Mn(),ge;function ie(v,P,S){We(v);const D=ve.list();return D.length?D.forEach(X=>X(v,P,S)):console.error(v),Promise.reject(v)}function ne(){return ge&&l.value!==vt?Promise.resolve():new Promise((v,P)=>{Ce.add([v,P])})}function We(v){return ge||(ge=!v,Ne(),Ce.list().forEach(([P,S])=>v?S(v):P()),Ce.reset()),v}function Mt(v,P,S,D){const{scrollBehavior:X}=t;if(!an||!X)return Promise.resolve();const fe=!S&&Ob(Jo(v.fullPath,0))||(D||!S)&&history.state&&history.state.scroll||null;return di().then(()=>X(v,P,fe)).then(q=>q&&Rb(q)).catch(q=>ie(q,v,P))}const ze=v=>r.go(v);let Ae;const nn=new Set,hs={currentRoute:l,listening:!0,addRoute:b,removeRoute:x,hasRoute:U,getRoutes:k,resolve:R,options:t,push:W,replace:K,go:ze,back:()=>ze(-1),forward:()=>ze(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:ve.add,isReady:ne,install(v){const P=this;v.component("RouterLink",gv),v.component("RouterView",vv),v.config.globalProperties.$router=P,Object.defineProperty(v.config.globalProperties,"$route",{enumerable:!0,get:()=>un(l)}),an&&!Ae&&l.value===vt&&(Ae=!0,W(r.location).catch(X=>{}));const S={};for(const X in vt)S[X]=$e(()=>l.value[X]);v.provide(Ui,P),v.provide(wc,Pn(S)),v.provide(Yr,l);const D=v.unmount;nn.add(v),v.unmount=function(){nn.delete(v),nn.size<1&&(c=vt,be&&be(),be=null,l.value=vt,Ae=!1,ge=!1),D()}}};return hs}function on(t){return t.reduce((e,n)=>e.then(()=>n()),Promise.resolve())}function wv(t,e){const n=[],s=[],r=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(c=>In(c,a))?s.push(a):n.push(a));const l=t.matched[o];l&&(e.matched.find(c=>In(c,l))||r.push(l))}return[n,s,r]}const xr=[{path:"Home",alias:"Home",component:()=>$t(()=>import("./Home-02156806.js"),[])},{path:"About",alias:"About",component:()=>$t(()=>import("./About-6fbd8962.js"),[])},{path:"Products",alias:"Products",component:()=>$t(()=>import("./Products-d47a7cb4.js"),["assets/Products-d47a7cb4.js","assets/Group19-49c36de6.js"])},{path:"Personal/:id",alias:"Personal/:id",component:()=>$t(()=>import("./Personal-ddd87199.js"),[])},{path:"PersonalArea/:id",alias:"PersonalArea/:id",component:()=>$t(()=>import("./PersonalArea-e85057db.js"),[])},{path:"Blog",alias:"Blog",component:()=>$t(()=>import("./Blog-cc33d55c.js"),[])},{path:"Checkout",alias:"Checkout",component:()=>$t(()=>import("./Checkout-a725c0cb.js"),["assets/Checkout-a725c0cb.js","assets/Group19-49c36de6.js"])}],Ev=yv({history:Lb("/"),routes:[{path:"/",name:"root",redirect:t=>ce().lang},{path:"/ru",name:"ru",redirect:t=>"ru/Home",beforeEnter:async(t,e,n)=>{ce().lang="ru",await ce().process(),await ce().checkStatus(),await ce().getData(),ce().getCart(),n()},children:xr},{path:"/en",name:"en",redirect:t=>"en/Home",beforeEnter:async(t,e,n)=>{ce().lang="en",await ce().process(),await ce().checkStatus(),ce().getData(),ce().getCart(),n()},children:xr},{path:"/kg",name:"kg",redirect:t=>"kg/Home",beforeEnter:async(t,e,n)=>{ce().lang="kg",await ce().process(),await ce().checkStatus(),ce().getData(),ce().getCart(),n()},children:xr}],strict:!0});const ar=Yf(mb),Iv=Zf();new Re;const xv={apiKey:"AIzaSyBTSEZwHNPgKNuBJggnTFcdjmC9RR4R7NA",authDomain:"craft-honey.firebaseapp.com",projectId:"craft-honey",storageBucket:"craft-honey.appspot.com",messagingSenderId:"601806986687",appId:"1:601806986687:web:d7b903e0736c4d4d35550a"};ar.component("Layout",hb);ar.use(Iv);ar.use(Ev);kl(xv);En();ar.mount("#app");export{Ue as F,hb as L,at as _,ee as a,m as b,we as c,Ie as d,Qs as e,Tv as f,En as g,Sp as h,kv as i,ye as j,ft as k,nt as l,Qr as n,he as o,Xt as r,Sv as s,j as t,ce as u,Wt as v,Le as w};

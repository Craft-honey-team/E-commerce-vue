<template>
  <Layout>
    <div class="fex">
      <h1 class="ml-[10%] mb-[30px] mt-[20px] text-[40px]"> <strong>О нас</strong> </h1>
      <div class="justify-center flex ">

        <img class="mb-[40px] w-[80%] h-[50%]" src="../assets/Rectangle 17.png" alt="">
      </div>
      <div class="leading-[180%] text-justify ">
        <div class="text-[16px] mb-[8%]">
          <article class="indent-[15px] ml-auto mr-auto w-[68em]">

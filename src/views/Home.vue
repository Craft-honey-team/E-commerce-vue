...
<Layout>
  ...
  <img :style = "{'transform': `translate(${xPos/24}px, ${yPos/24}px)` }" class = "select-none max-w-none w-[32%] h-[66%] absolute left-[40%] bottom-[-30px] z-[-9] max-[800px]:w-[50%]" src="../assets/paralax3b.png" />
    ...
    <div class = "grid gap-[10vh] [&_*]:text-white">
      ...
      <div class="rounded-full justify-center flex max-[800px]:pt-[10px]">
      	  <div class="grid grid-cols-2 gap-[20vw] max-[800px]:grid-cols-1 max-[800px]:gap-[10px]">
          	<button class="relative z-10 text-black bg-yellow-500 w-40 h-12 rounded-md">Блог</button>

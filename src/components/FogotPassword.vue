<template>
    <div class="grid grid-cols-2  h-[500px] [&_*]:font-roboto [&_input]:pl-[8px]">
        ...
        <h1 class="text-[30px] max-[350px]:text-[20px]">Восстановление пароля </h1>
        <input v-model="email"
                ...
                <span v-if="errorMessge" class="text-red-500 font-roboto">Такого пользователя не существует</span>
        </div>
    </div>
